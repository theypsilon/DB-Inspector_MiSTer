...
You can use this alternative version instead. It is more robust because it is DOM-only, at the cost of runtime performance (works well on smaller databases): https://theypsilon.github.io/DB-Inspector_MiSTer/dom/
